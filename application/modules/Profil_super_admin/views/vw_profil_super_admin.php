...
<head>
  ...
  <title>E-Bpjs | Profil Super Admin</title>
...
<!-- end header -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Profil Super Admin</li>
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header">
              <h3 class="box-title">Tabel Data Super Admin</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center">
                  <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Profil_super_admin/detail/".md5(sha1($baris->id_login_super_admin)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
