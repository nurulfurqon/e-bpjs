...
<head>
  ...
  <title>E-Bpjs | Detail Profil Super Admin</title>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Detail Profil Super Admin</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Profil_super_admin/detail/".md5(sha1($detail->id_login_super_admin))); ?>">
                    <div class="box-body">
                        <div class="col-md-6">
                            <fieldset disabled>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onClick="location.href='<?php echo site_url("Profil_super_admin");?>'"><span class="fa fa-times"></span> Batal</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
