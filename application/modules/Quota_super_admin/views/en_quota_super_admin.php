      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Quota_super_admin/tambah"); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                          <div class="col-md-6">
                              ...
                              <select name="nik_pegawai" id="nik_pegawai" class="form-control chosen-select">
                                <?php
                                 if(isset($_POST['nik_pegawai'])){
                                     $ambil = $this->m_quota_super_admin->getJabatan($_POST['level_jabatan']);
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
           type : "POST",
           url  : "<?php echo site_url('Quota_super_admin/ambil_jabatan'); ?>",
    ...
    $(function(){
        ...
        $.ajax({
           type : "POST",
           url  : "<?php echo site_url('Quota_super_admin/ambil_quota'); ?>",
