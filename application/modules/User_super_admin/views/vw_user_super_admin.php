...
<head>
  ...
  <title>E-Bpjs | User Super Admin</title>
          ...
          <div class="box box-default">
            <div class="box-header">
              ...
              <div class="box-title col-md-12">
                <div class="row">
                  <form action="<?php echo site_url('User_super_admin')?>" class="form-horizontal" method="post">
        				  <div class="col-md-2">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center">
                    <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("User_super_admin/detail/".md5(sha1($baris->id_login_user)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                    <button type="button" name="btn_hapus" class="btn btn-sm btn-primary"  onclick="return hapus_data('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("User_super_admin/hapus/".$baris->id_login_user);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
            ...
            <!-- /.box-body -->
              ...
              <?php
    					...
    					{
    					?>
              <a href="<?php echo site_url("User_super_admin"); ?>">
