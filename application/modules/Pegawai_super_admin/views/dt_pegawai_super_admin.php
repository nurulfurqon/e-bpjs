      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Pegawai_super_admin/detail/".md5(sha1($detail->nik))); ?>">
                    <div class="box-body">
...
<script>
  ...
  $(document).ready(function (e){
    ...
    e.preventDefault();
      $.ajax({
      url: "<?php echo site_url('Pegawai_super_admin/ubah_foto/'.md5(sha1($detail->nik)));?>",
      type: "POST",
