...
<head>
  ...
  <title>E-Bpjs | Entry Admin Super Admin</title>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Entry Data Admin</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Admin_super_admin/tambah"); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="col-md-6">
                              ...
                              <select name="nik_pegawai" id="nik_pegawai" class="form-control chosen-select">
                                <?php
                                 if(isset($_POST['nik_pegawai'])){
                                     $ambil = $this->m_admin_super_admin->getJabatan($_POST['level_jabatan']);
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
           type : "POST",
           url  : "<?php echo site_url('Admin_super_admin/ambil_jabatan'); ?>",
