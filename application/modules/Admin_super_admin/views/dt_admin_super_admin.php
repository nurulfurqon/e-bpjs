...
<head>
  ...
  <title>E-Bpjs | Detail Admin Super Admin</title>
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Admin_super_admin/detail/".md5(sha1($detail->id_login_admin))); ?>">
                    <div class="box-body">
                        <div class="col-md-6">
                            <fieldset disabled>
                            ...
                            <div class="form-group <?php if(form_error('quota')){echo "has-error";} ?>">
                                ...
                                <select name="status"  class="form-control" id="cbo_type">
                									<option value="" selected="selected">-Pilih-</option>
                                  <option <?php if (!(strcmp($detail->status,"1"))) {echo "selected=\"selected\"";} ?>  value="1"<?php echo $detail->status ?>>Aktif</option>
                									<option <?php if (!(strcmp($detail->status,"0"))) {echo "selected=\"selected\"";} ?>  value="0"<?php echo $detail->status ?>>Tidak Aktif</option>
                								</select>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onClick="location.href='<?php echo site_url("Admin_super_admin");?>'"><span class="fa fa-times"></span> Batal</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
