...
<head>
  ...
  <title>E-Bpjs | Admin Super Admin</title>
...
<!-- end header -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Admin Super Admin</li>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center">
                  <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Admin_super_admin/detail/".md5(sha1($baris->id_login_admin)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                  <button type="button" name="btn_hapus" class="btn btn-sm btn-primary"  onclick="return hapus_data('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Admin_super_admin/hapus/".$baris->id_login_admin);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
